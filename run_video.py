...
#模型有help里面的种类，大模型的处理速度会很慢，开始预训练使用mobilenet_thin就可以
    parser.add_argument('--model', type=str, default='mobilenet_thin', help='mobilenet_thin / mobilenet_v2_large / mobilenet_v2_small')
    ...
    cam = cv2.VideoCapture('zheng.mp4')
    ...
    videoWriter = cv2.VideoWriter('zheng.avi', fourcc, fps, frame_size)
    while ret_val:
